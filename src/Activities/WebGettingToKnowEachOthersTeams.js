...
<em>Requirement 1</em>
<p>Create a public GitHub repository and static Azure website that:</p>
<ol>
	<li>Allows each team members to add, edit, and update source code in the GitHub repository</li>
	<li>Automatically updates the associated static Azure website when GitHub is updated</li>
</ol>
