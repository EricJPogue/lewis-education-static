...
import { JSONWebServicesTutorial, codingStandards, externalLink } from '../Links';
...
export const lionsTigersAndBears = () => { 
	...
	return ( <div>
		...
		of various dog breeds in a slide show utilizing a public API. Then we can practice our web hosting skills be 
		hosting the application in Azure. Finally, we can create our own application using our newly acquired 
		JavaScript, JSON, and AJAX skills along with our existing CI/CD and {azureWebsiteLink()} capabilities to build 
		something interesting and uniquely our own</p>
