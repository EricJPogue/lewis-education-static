...
export const HelloWorldWeb = () => { 
	...
	return ( <div>
		...
		<h5>Summary: Create and host Hello World for the Web</h5>
		...
		should always be utilized in written text. This {practicalTypographyArticle()} does a nice job of explaining the 
		rational. Equally important, becoming comfortable with utilizing curly quotes and curly apostrophes is a good 
		starting point for understanding how to utilize special characters and eventually multiple languages in software 
		applications.</p>
