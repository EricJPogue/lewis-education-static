...
export const al49200Sprint01 = (syllabusURL) => {
	return (

<div>
<h5>Sprint 1: Product Team Assignments, Software Engineering Life Cycles and Agile Review, and Tools of the Trade</h5>
<p><em>Welcome to Software Systems Capstone!</em> By this point in your software development journey I'm sure you are 
confident in writing moderately complicated software programs. You’ve learned about structured programming techniques 
and how to break break complicated programs down into more manageable pieces by using functions and services. You even 
understand how Object-Oriented Programming can help you develop more complex applications by utilizing encapsulation, 
inheritance, and polymorphism. You even understand Software Engineering, software development life cycles (SDLCs) 
including Agile and Scrum, and application architecture.</p>
...
scrum product team. So we will start the semester with identifying product and team assignments. Once assigned to a 
...
<ul style={{listStyleType:'square'}}>
	...
	<li>Implement the key Agile Software Development Life Cycle Roles, Activities, and Artifacts for your scrum team</li>
	<li>Explain why agile development has become the preferred software development process</li>
	<li>Describe the benefits of cloud computing and modern Web development stacks including MERN</li>
	<li>Utilize leading developer tools to create and update software applications</li>
</ul>

{ActivitiesListIntro()}
<ol>
	<li>Request a product team by submitting Requirement 1 of {classProductSprint1Link()} to me by noon on <em>Wednesday, January 12th</em>.</li>
	...
	<li>Within {oreillyPlaylistSC()} read “Essential Scrum” from the beginning through chapter 4<sup> ~2 hours</sup></li>

	{InitialPost()}

	<li>Within {oreillyPlaylistSC()} read “Essential Scrum” chapters 4 through 8<sup> ~2 hours</sup></li>
	<li>Within {oreillyPlaylistSC()} read “Essential Scrum” chapters 9 and 10</li>
	{ProgrammingActivity(ToolsOfTheTrade, 1)}

	{StandardActivitiesClosing(GettingToKnowEachOther)}
</ol>
The best advise that I can give you is to start early, submit something for each assignment, and to focus on your scrum 
team and the product your team will be developing. 
</div>
