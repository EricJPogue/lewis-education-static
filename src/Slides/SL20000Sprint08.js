...
export const ics_8_1of6 = () => { return [tUnderConstruction ] }
...
export const ics_8_4of6 = () => { return [tUnderConstruction ] }

// Sprint 8 session 5 of 6: Wednesday
export const ics_8_5of6 = () => { return [tUnderConstruction ] }

// Sprint 8 session 6 of 6: Friday
export const ics_8_6of6 = () => { return [tUnderConstruction ] }